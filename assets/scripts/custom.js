$(document).ready(function () {
    ...
    function init_template(){//Class is vital to run AJAX Pages
        ...
        var swiper_home_slider = new Swiper('.homepage-slider', {autoplay:3500});
        ...
        $('.accordion').find('.accordion-toggle').click(function(){
            ...
            $(this).next().find('img').trigger("unveil");
            // $('.accordion').find('i').toggleClass('rotate-180');
        ...
        //Tabs
        // $("ul.tabs li").eq(1).addClass("active-tab").show(); //Activate second tab
        ...
        $('.adaptive-one').click(function(){
            ...
            // $('.portfolio-adaptive').addClass('user-feed');
            return false;
        });
